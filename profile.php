...
if ( isset( $_POST['save_profile'] ) ) 
{
  ...
  $sql = "UPDATE `users` SET `username`='$user', `mobile`='$mobile', `bio`='$bio',
...
<div class="container rounded bg-white mt-5 mb-5">
    ...
    $profile_pic_db = $get_pic_row['profile_pic'];
        if ($profile_pic_db == "") {
        $profile_pic2 = "<div class='d-flex flex-column align-items-center text-center p-3 py-5'><img class='rounded-circle mt-5' width='150px' src='images/user.png'><span class='font-weight-bold'>$user</span><span class='text-black-50'>$email</span></div>";
        echo $profile_pic2;
        }
            else
        {
            $profile_pic2 = "userdata/".$profile_pic_db;
            echo "<div class='d-flex flex-column align-items-center text-center p-3 py-5'><img class='rounded-circle mt-5' width='150px' height='150px;' src='$profile_pic2'><span class='font-weight-bold'>$user</span><span class='text-black-50'>$email</span><span> </span></div>";
    ...
    ?>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Name</label><input type="text" name="username" class="form-control" placeholder="Your name" value="<?php echo $user?>"></div>
...
?>
                ...
                <input type="file" name="img" id="upload" hidden/><label for="upload" class="border px-3 p-1 add-experience"><i class="fa fa-plus"></i>&nbsp;Profile Picture</label></div><br>
                <div class="mt-5 text-center"><input class="btn btn-primary profile-button" type="submit" name="upload_cover" value="Upload" /></div>
                </form>
<?php 
...
?>
                ...
                <div class="mt-5 text-center"><input class="btn btn-danger delete-button" type="submit" name="delete_cover" value="Delete Profile Picture" /></div></form>
            </div>
        </div>
    </div>
