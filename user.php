...
<?php
        ...
        if ($profile_pic_db == "") {
          ...
          ID#$username</a></div></div> E-mail : $email || User Type: $user_type <div class='col-sm' style='font-size: 13.5px; color: #666;'>Contact-Number : $mobile || Assigned On : $date<a href='delete.php?id=$id'><button style='margin-left: 70px;' type='button' class='btn btn-outline-danger'>Delete</button></a></div></div></div>";
          }
              else{
