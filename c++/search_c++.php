    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <img src="../images/logo.png" width ="40px">
        ...
        <form action="search_c++.php" method="GET">
            <input type="text" name="q" placeholder="Find your questions and all the c++ modules..." value="<?php echo $q;?>" style="width: 90%; padding-top: 10px; padding-bottom: 10px; border: 1px solid #ccc; border: 0 none; border-bottom: 2px solid #eee; outline: none; background: #fcfcfc; padding-left: 10px;" />
        ...
        if ($submit) {
            $search = "SELECT * FROM `courses` WHERE course_category ='c++' AND course_topic LIKE '%$q%' LIMIT 20";
