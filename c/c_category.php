...
<?php
        ...
        <?php  if ($ut == 'student') {
          if($active == 1) {
              ...
              <a href='c_module.php?id=$id'><div class='card-1' style=' overflow-y: scroll; padding: 20px;'><b class='col-md-8' style='font-size: 20px;'>$cat_name</b></div></a>
              </div>";
        } else {
          echo "<div id='card' class='col-md-4' style='margin-top: 15px; '>
          <a href='c_module.php?id=$id'><div class='card-1' style=' overflow-y: scroll; padding: 20px;'><b class='col-md-8' style='font-size: 20px;'>$cat_name</b></div></a>
