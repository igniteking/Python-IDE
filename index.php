   ...
   <div id='flip-card-back'><p style='font-size: 40px; color: #F4B400;'>$rowcount</p></div>
      ...
      <div id='card' class='md-4'>
        <div class="mt-5"><a href="download.php"><button class="btn btn-success profile-button" type="submit" name="upload_cover">
              <lord-icon src="https://cdn.lordicon.com/wxnxiano.json" trigger="morph-two-way" colors="primary:#ffffff,secondary:#ffffff" style="width:50px;height: 50px">
              </lord-icon> Download .csv
            </button></a></div>
