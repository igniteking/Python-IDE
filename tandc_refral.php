  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <img src="images/logo.png" width ="40px">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="registration_refral.php">Registration Page</a>
        </li
      </ul>
    </div>
  </div>
...
<div class="container">
<h4 style="text-align: center; padding: 20px;">Terms and Conditions</h4>
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Introduction</h4>
<p style="padding: 40px; font-size: large;">
Glowworm Renewable Energy Private Limited, having its registered office at Ishavasyam, Opp. Lajpatnagar, Eeshita Towers Road, Navrangpura, Navjeevan, Ahmedabad-380 014, Gujarat, India (“Company” or “we” or “us”), is the owner of the website domain at https://glowedu.co.in(referred as “Platform”) The Company requests the User (as defined below) to carefully go through these terms & conditions (“Terms of Service” or “Agreement” or “Terms & Conditions ”) prior to accessing the Platform or availing Services (as defined below) using the Platform. If User continues to browse and use the Platform to avail Services, User irrevocably and unconditionally is agreeing to comply with, abide by and be bound by all these obligations as stipulated in this Terms & Conditions , which together read with our privacy policy available at https://www.glowedu.co.in/privacy-policy (“Privacy Policy”); and any other applicable policies referred to herein or made available on the Platform (collectively referred as “Terms and Conditions”). The Terms and Conditions shall govern the Company’s relationship with User in relation to the usage of the Platform. These Terms and Conditions supersede all previous oral, written terms and conditions (if any) communicated to User and shall act as a binding agreement between Company and the User. BY SUBSCRIBING OR PURCHASING ANY SERVICES USING THIS PLATFORM , YOU BY ALL MEANS CONFIRM AND AGREE TO BE BOUND WITH ALL TERMS AND CONDITIONS CAPTURED IN THE TERMS & CONDITIONS OF SERVICES ,    </div>
  </div>
  <br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Definition</h4>
<p style="padding: 40px; font-size: large;">
“Company,“ “we,“ “us,“ or “our“ means Glowworm Renewable Energy Private Limited and any other companies that are its subsidiaries and affiliates. “Service(s)“ means services provided through the Platform, as described in further detail under clause 3 below. The Services provided through the Platform may change from time to time, at the sole discretion of the Company. “User” or “You” shall mean any registered user of the Platform, or his/her representatives or affiliates who are registered on the Platform.    </div>
  </div>
</div>
  <br><br>
  <div class="container">
...
<p style="padding: 40px; font-size: large;">
Company offers its Users with various training courses in relation to academic subjects , music, chess, dance, yoga and various other trainings/courses as further published on the Platform (“Services”). The Services are offered both through live online classes as well as pre-recorded sessions.Kindly note that the list provided herein is exhaustive. The Services may vary as per the course which you have opted. The Services shall be provided by Company through the trainers who have been appointed by Company (“Instructor”).  </div>
</div>
<br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Eligibility</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">User account registration</h4>
<p style="padding: 40px; font-size: large;">
...
You can create an Account by using your email ID/phone number. Post entering your details (email ID/phone number) in the Platform, one-time verification shall be conducted by the Company. Post verification Account shall be created. You can also create Account by logging into your account with certain third-party social networking websites including Google, Facebook etc. “Third- Party Account”, via our Platform, as described below:
...
II. By granting Company access to any Third-Party Account, you understand that the Company will access, make available and store (if applicable) any content that you have provided to and stored in your Third-Party Account, so that it is available on and through the Platform. Unless otherwise specified in these Terms & Conditions , all Social Networking Sites Content, if any, will be considered to be User’s data for all purposes of these Terms & Conditions . Depending on the Third-Party Accounts you choose and subject to the privacy settings that you have set in such Third-Party Accounts, personal information that you post to your Third-Party Account will be available on and through your Platform.

III. Please note that if a Third- Party Account becomes unavailable, or User’s access to such Third-Party Account is terminated by the third-party service provider, then Social Networking Sites Content will no longer be available on and through the Platform. You have the ability to disable the connection between your Account and your Third-Party Accounts, at any time, by accessing the “Settings” section of the Platform and Application. However, under such circumstances, the Services may be discontinued by the Company, at its sole discretion.

IV. Please note that your relationship with any third- party service providers associated with your third- party accounts is governed solely by your agreement(s) with such third- party service providers. Company makes no effort to review any Social Networking Sites Content for any purpose, including but not limited to, for accuracy, legality or non-infringement and Company is not responsible for any Social Networking Sites Content.</div>
</div></div>
<br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Platform license</h4>
<p style="padding: 40px; font-size: large;">
Subject to your compliance with the Terms & Conditions , Company grants you a limited, non-exclusive, non-transferable license: (i) to view, download and print any content of Platform solely for your personal and non-commercial purposes; and (ii) to access, modify, edit and download any content, to which you are permitted access solely for your personal and non-commercial purposes. You have no right to sublicense the license rights granted herein.

​
You will not use, copy, adapt, modify, prepare derivative works based upon, distribute, license, sell, transfer, publicly display, publicly perform, transmit, stream, broadcast or otherwise exploit the Platform and Services, except as expressly permitted in the Terms & Conditions . No licenses or rights are granted to you by implication or otherwise under any intellectual property rights owned or controlled by Company or its licensors, except for the licenses and rights expressly granted in the Terms & Conditions . The Platform and the intellectual property rights vested therein is owned by the Company.  </div>
</div></div></div>
  <br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Usage of the platform and Fee</h4>
<p style="padding: 40px; font-size: large;">
The usage of the Platform is free of cost and the Company is not charging any fees for usage of Platform. However, Users shall be liable to pay fees for the Course /Subscription /Services offered which User desires to subscribe.Payment against fees can be made online through credit Card/internet banking etc. or any mode of payment which is made available to the User on this Platform.
</div>
  </div></div>
  <br><br>
<div class="container">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Use of your information and content and other content displayed on the platform</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Third party services</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Rules of Conduct</h4>
<p style="padding: 40px; font-size: large;">
As a condition of use, you promise not to use the Services for any purpose that is prohibited by the Terms & Conditions ; or other rules or policies implemented by us from time to time; or in violation of any applicable laws. The Services (including, without limitation) is provided only for your own personal and non-commercial use.
...
By submitting suggestions or other feedback regarding our Services/Platform, you agree that we can use and share such feedback for any purpose without any compensation to you and we are under no obligation to give such feedback confidential.</div>
</div></div>
<br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Profile ownership and editing rights</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Rights and obligation relating to the usage of the platform</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Indemnification</h4>
<p style="padding: 40px; font-size: large;">
You shall defend, indemnify, and hold harmless the Company, its affiliates/subsidiaries/joint venture partners and each of its, and its affiliates’/subsidiaries/joint venture partners’ employees, contractors, directors, suppliers and representatives from all liabilities, losses, claims, and expenses, including reasonable attorneys’ fees, that arise from or relate to (i) your use or misuse of, or access to, the Services and Platform; or (ii) your violation of the Terms and Conditions; or any applicable law, contract, policy, regulation or other obligation. We reserve the right to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you will assist and cooperate with us in connection therewith.</div>
</div></div>
<br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Limitation of liability</h4>
<p style="padding: 40px; font-size: large;">
TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT SHALL COMPANY (INCLUDING ITS DIRECTORS, EMPLOYEES, AGENTS, SPONSORS, PARTNERS, SUPPLIERS, CONTENT PROVIDERS, LICENSORS OR RESELLERS,) BE LIABLE UNDER CONTRACT, TORT, STRICT LIABILITY, NEGLIGENCE OR ANY OTHER LEGAL OR EQUITABLE THEORY WITH RESPECT TO THE SERVICES (I) FOR ANY LOST PROFITS, DATA LOSS, LOSS OF GOODWILL OR OPPORTUNITY, OR SPECIAL, INDIRECT, INCIDENTAL, PUNITIVE, OR CONSEQUENTIAL DAMAGES OF ANY KIND WHATSOEVER, (II) FOR YOUR RELIANCE ON THE SERVICES (III) FOR ANY DIRECT DAMAGES IN EXCESS (IN THE AGGREGATE) OF THE INR 2000/- (IV) FOR ANY MATTER BEYOND ITS OR THEIR REASONABLE CONTROL, EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF ANY OF THE AFOREMENTIONED DAMAGES.</div>
</div></div>
<br><br>
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Exemptions to liability of company</h4>
<p style="padding: 40px; font-size: large;">
...
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Grievance redressal mechanism</h4>
<p style="padding: 40px; font-size: large;">
...
Authorized Person: Aditya Shah

Email ID: info@glowedu.co.in

Address: Ishavasyam, Opp. Lajpatnagar, Eeshita TowersRoad, Navrangpura, Navjeevan, Ahmedabad-380 014, Gujarat, India</div>
</div></div>
<br><br>
<div class="container">
  <div class="row">
    <div class="col" style="  box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23);">
<h4 style="text-align: center; padding: 20px;">Contact</h4>
<p style="padding: 40px; font-size: large;">
If you have any questions regarding the Services or usage of the Platform, please contact Company info@glowedu.co.in Please note that for the purpose of validation, you shall be required to provide information (including, but not limited to contact number or registered mobile number, etc.) for the purpose of validation and taking your service request.</div>
  </div><br><br>
