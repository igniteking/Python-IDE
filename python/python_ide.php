...
<?php
    ...
    ?>
  	<title>Python IDE - GlowEdu</title>
    <meta charset="utf-8">
...
<?php
    $next_id = "";
    $next_sql = "SELECT * FROM courses WHERE id > $Course_id AND course_category = 'python'ORDER BY id DESC";
...
<?php
    $pre_id = "";
    $pre_sql = "SELECT * FROM courses WHERE id < $Course_id AND course_category = 'python' ORDER BY id ASC";
