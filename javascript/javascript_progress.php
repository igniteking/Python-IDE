...
<body>
  ...
  <button type="submit" class="btn btn-primary">Search
    <i class="fa fa-search"></i>
        ...
        <?php
        $sql = "SELECT * FROM courses WHERE course_category='javascript'";
        $query = mysqli_query($conn, $sql);
        $count_total_course = mysqli_num_rows($query);

        $sql2 = "SELECT * FROM match_id WHERE student_id='$user_id' AND course_category='javascript'";
        ...
        ?>
        <h2 style="float: left;">Completed Modules of javascript<i class="fa fa-check" style=" color:#67ce8b;" aria-hidden="true"></i></h2>
        <br><br>
        <script>
            function showAlert() {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            $sql2 = "SELECT * FROM courses WHERE id='$course' AND course_category='javascript'";
            $query2 = mysqli_query($conn, $sql2);
