...
<?php
    ...
    ?>
  	<title>Javascript IDE - GlowEdu</title>
    <meta charset="utf-8">
...
<?php
    $course_int = "Welcome, $user<br> To Javascript IDE... <br><br><br> All The Best!<br>";
    $id = $_GET['id'];
...
<?php
    ...
    if ($next_id == "") {
      ...
      $final_next_id = "javascript_ide.php?id=" . $next_id;
    }
    ?>
        <?php
    $pre_id = "";
    ...
    if ($pre_id == "") {
      $final_pre_id = "javascript_category.php";
    } else {
      $final_pre_id = "javascript_ide.php?id=" . $pre_id;
    }
?>
<?php
...
<div class="row mt-12">
    <div class="col-md-4"><a href='<?php echo $final_pre_id?>' style='text-decoration: underline; font-size:large;'> << Back </a></div>
      ...
      if($result_check == 0) {
        ...
        <form action='javascript_ide.php?id=$id' method='POST'>
